	...
	<body class="is-preload">
		...
		<!-- Wrapper-->
			<div id="wrapper">
				...
				<!-- Nav -->
					<nav id="nav">
						<a href="Gender.php" class="icon solid fa-chevron-circle-left "><span>Previous</span></a>
						<a href="#videos" class="icon solid fa-video"><span>Videos</span></a>
						<a href="#Music" class="icon solid fa-music"><span>Music</span></a>
						<a href="#Diseases" class="icon solid fa-medkit"><span>Diseases</span></a>
        ...
        <div class="control">
          <div class="button" id="play-next">
            <i class="fas fa-forward"></i>
						...
						<!--Diseases-->
							<article id="Diseases" class="panel">
								<header>
									<h2>Diseases</h2>
...
<ul>
 <li><a href="Anxiety.php">Anxiety</a></li>
  <li><a href="BrainHealth.php">Brain Health</a></li>
  <li><a href="Happiness.php">Happiness</a></li>
  <li><a href="Loneliness.php">Loneliness</a></li>
  <li><a href="PainDisorder.php">Panic Disorder</a></li>
